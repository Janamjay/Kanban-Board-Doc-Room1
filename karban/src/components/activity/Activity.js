    ...
    <div className={style.main}>
      ...
      <span className={style.disc}>
        ...
        <div className={style.comment}>
            ...
            <span><button className={style.save}>Save</button></span>
            <span><button onClick={handleClick} className={style.cancel}>Cancel</button></span>
            </div>
        ...
        {details ? (
          <>
            ...
            <div className={style.mainActivityBox}>
              ...
              <img className={style.userImages} alt="user" src=" https://e7.pngegg.com/pngimages/799/987/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail.png" width="40px" height="40px"/> 
              </span>
